  ...
  \section{Prakticka časť}
    ...
    \subsection{Modelovanie}
      ...
      \subsection{Obal}
        ...
        \begin{center}
          \includegraphics[width=10cm]{box/14} \\
        \end{center}

        Kratsia strana: \\

        \begin{center}
          \includegraphics[width=10cm]{box/15}
        \end{center}

        Posledna horna cast modelu: \\

        \begin{center}
          \includegraphics[width=10cm]{box/16}
        \end{center}
        ...
        \begin{center}
          \includegraphics[height=10cm,angle=90]{box/19}
          \vfill{}
          \includegraphics[width=10cm]{box/20}
        \end{center}

        Hotový obal vyzerá nasledovne:

        \begin{center}
          \includegraphics[width=10cm]{box/21}
        \end{center}
      \subsection{Kľučenky}
        ...
        \begin{center}
          \includegraphics[width=10cm]{keychains/1}
        \end{center}

        Pridal som strih na zväčšenie objemu v strednej časti modelu. \\
        \begin{center}
          \includegraphics[width=10cm]{keychains/2}
        \end{center}
